...
function getDateCreatedObject(param) {
...
function getFilterRequestBody(
  ...
  if (filter !== undefined) {
    var filters = Caml_option.valFromOption(filter);
    if (!LogicUtils.checkEmptyJson(filters)) {
      body["filters"] = filters;
    }
  }
  if (distributionValues !== undefined) {
    var distributionValues$1 = Caml_option.valFromOption(distributionValues);
    if (!LogicUtils.checkEmptyJson(distributionValues$1)) {
      body["distribution"] = distributionValues$1;
    }
  }
...
function deltaDate(fromTime, _toTime, typeTime) {
  ...
  var currentWeekFromTime = DateTimeUtils.getStartOfWeek(
    new Date(),
    /* Monday */ 1,
  );
...
function generatePayload(
  ...
  if (filters !== undefined) {
    var filters$1 = Caml_option.valFromOption(filters);
    if (!LogicUtils.checkEmptyJson(filters$1)) {
      newDict["filters"] = filters$1;
    }
  }
  return newDict;
}
...
function singlestatDeltaTooltipFormat(value, timeRanges, statType) {
  var timeText =
      ...
      tooltipComp = React.createElement(
        ...
        React.createElement(AddDataAttributes.make, {
          ...
          children: React.createElement(
            "div",
            {
              className: "text-status-green text-base font-bold font-fira-code",
            },
            value$5,
          ),
        }),
      ...
      React.createElement(
        ...
        React.createElement(Button.make, {
          ...
          onClick: function (param) {
            var element =
              document.getElementsByClassName("showFilterButton")[0];
        ...
        React.createElement(Button.make, {
          ...
          onClick: function (param) {
            var element =
              document.getElementsByClassName("daterangSelection")[0];
            if (element === undefined) {
              return;
            }
            var nodeElement = element.childNodes[0];
            ...
            var nodeElement$1 =
              Caml_option.valFromOption(nodeElement).childNodes[0];
