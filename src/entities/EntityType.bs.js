...
function getDefaultEntityOptionType(param) {
  return {
    urlKey: "",
...
function defaultGetSummary(json, totalCountKey) {
  ...
  var summary_totalCount = LogicUtils.getInt(dict$1, totalCountKey, 0);
  var summary_count = LogicUtils.getInt(dict$1, "count", 0);
  var summary = {
...
function makeEntity(
  ...
  var dateRangeFilterDict =
    dateRangeFilterDictOpt !== undefined
      ? Caml_option.valFromOption(dateRangeFilterDictOpt)
      : {};
  var filterCheck =
  ...
  return {
    ...
    defaultFilters:
      defaultFilters !== undefined
        ? Caml_option.valFromOption(defaultFilters)
        : dict,
    headers: headers,
