...
function UserPrefContext(props) {
  var userPrefInitialVal = UserPrefUtils.getUserPref(undefined);
  var match = React.useContext(AuthInfoProvider.authStatusContext);
  var authStatus = match[0];
  var username = typeof authStatus === "number" ? "" : authStatus._0.username;
  ...
  React.useEffect(
    function () {
      if (urlPathConcationation !== "/") {
        Curry._1(setUserPref, function (prev) {
  ...
  React.useEffect(
    function () {
      Curry._1(setUserPref, function (prev) {
        ...
        var moduleWisePref =
          moduleVisePref !== undefined
            ? Caml_option.valFromOption(moduleVisePref)
            : {};
        ...
        newrecord$1.moduleVisePref = Caml_option.some(moduleWisePref);
    ...
    Curry._1(setUserPref, function (prev) {
      ...
      var moduleConfig$1 =
        moduleConfig !== undefined
          ? Caml_option.valFromOption(moduleConfig)
          : {};
      moduleConfig$1[key] = value;
      var newrecord = Caml_obj.obj_dup(currentModulePerf);
      newrecord.moduleConfig = Caml_option.some(moduleConfig$1);
      moduleWisePref[urlPathConcationation] = newrecord;
      var newrecord$1 = Caml_obj.obj_dup(currentConfig);
      newrecord$1.moduleVisePref = Caml_option.some(moduleWisePref);
      prev[username] = newrecord$1;
  ...
  var getConfig = function (key) {
    ...
    var match = Core__Option.getOr(
      Caml_option.valFromOption(moduleVisePref)[urlPathConcationation],
      defaultUserModuleWisePref,
    );
    var moduleConfig = match.moduleConfig;
    if (moduleConfig !== undefined) {
      return Caml_option.valFromOption(moduleConfig)[key];
    }
  };
