...
function ChartContext(props) {
  ...
  var match$12 = React.useMemo(
    function () {
      ...
      var filterValueFromUrl = Caml_option.some(
        Object.fromEntries(
          Belt_Array.keepMap(
            Object.entries(getTopLevelChartFilter),
            function (entries) {
    ...
    function () {
      var chartType = LogicUtils.getString(
        ...
        DynamicChart.chartMapper(
          Core__Option.getOr(chartEntity.chartTypes[0], /* Line */ 0),
        ),
      );
      if (
        LogicUtils.isNonEmptyString(startTimeFromUrl) &&
        ...
        Curry._1(setTopChartFetchWithCurrentDependecyChange, function (param) {
          return false;
        });
      }
    },
  ...
  React.useEffect(
    function () {
      if (!topChartFetchWithCurrentDependecyChange && topChartVisible) {
        ...
        if (value !== undefined) {
          Curry._1(setTopChartDataLegendData, function (param) {
            return /* Loading */ 0;
          });
          Curry._1(setTopChartData, function (param) {
            return /* Loading */ 0;
          });
              ...
              return Core__Promise.$$catch(
                Curry._3(
                  ...
                  return Promise.resolve(
                    Curry._2(jsonTransFormer, metric, jsonObj),
                  );
                }),
                function (_err) {
  ...
  React.useEffect(
    function () {
      if (!bottomChartFetchWithCurrentDependecyChange && bottomChartVisible) {
        ...
        if (value !== undefined) {
          Curry._1(setBottomChartDataLegendData, function (param) {
            return /* Loading */ 0;
          });
          Curry._1(setBottomChartData, function (param) {
            return /* Loading */ 0;
          });
          var cardinality = cardinalityMapperToNumber(cardinalityFromUrl);
          var timeObj = Object.fromEntries([
...
function ChartContext$SDKAnalyticsChartContext(props) {
                          ...
                          fetchApi(
                            ...
                            JSON.stringify(
                              AnalyticsNewUtils.apiBodyMaker(
                                ...
                                customFilter$1,
                                undefined,
                                Caml_option.some(Curry._1(filterMapper, item)),
                                undefined,
                                undefined,
                                timeCol,
                                Core__Option.getOr(value.domain, ""),
  ...
  var chartData = React.useMemo(
    ...
    [topChartData, topChartDataLegendData, /* Loading */ 0, /* Loading */ 0],
  );
  var value = React.useMemo(
    function () {
      return {
