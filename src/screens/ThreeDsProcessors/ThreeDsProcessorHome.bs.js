...
function ThreeDsProcessorHome(props) {
  ...
  var summaryPageButton =
    currentStep >= 2
      ? React.createElement(ThreeDsProcessorHome$MenuOption, {
          updateStepValue: /* ConfigurationFields */ 0,
      ...
      : React.createElement(Button.make, {
          ...
          onClick: function (param) {
            RescriptReactRouter.push(
              HSwitchGlobalVars.appendDashboardPath("/3ds-authenticators"),
            );
          },
        });
          ...
          currentStep !== 0
            ? React.createElement(
                ConnectorAccountDetailsHelper.ConnectorHeaderWrapper.make,
                {
                  ...
                  connector: connectorName,
                  connectorType: /* ThreeDsAuthenticator */ 3,
                },
              )
            : React.createElement(
                Form.make,
