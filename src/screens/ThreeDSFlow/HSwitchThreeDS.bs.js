...
function HSwitchThreeDS$ActiveRulePreview(props) {
  ...
  var deleteCurrentThreedsRule = async function (param) {
    try {
      ...
      return Curry._1(setInitialRule, function (param) {});
    } catch (exn) {
      return Curry._8(
        showToast,
              ...
              onClick: function (param) {
                Curry._1(showPopUp, {
                  ...
                  handleConfirm: {
                    text: "Confirm",
                    onClick: function (param) {
                      deleteCurrentThreedsRule(undefined);
                    },
                  },
                });
              },
...
function HSwitchThreeDS(props) {
  ...
  var activeRoutingDetails = async function (param) {
    try {
      var threeDsUrl = APIUtils.getURL(
        /* THREE_DS */ 28,
        /* Get */ 0,
        undefined,
        undefined,
      ...
      var threeDsRuleDetail = await Curry._1(fetchDetails, threeDsUrl);
      ...
      return Curry._1(setInitialRule, function (param) {
        return Caml_option.some(intitialValue);
      });
    } catch (raw_e) {
  ...
  var fetchDetails$1 = async function (param) {
    try {
      ...
      if (e.RE_EXN_ID === Js_exn.$$Error) {
        ...
        if (err.includes("HE_02")) {
          Curry._1(setShowWarning, function (param) {
            return false;
          });
  ...
  var onSubmit = async function (values, param) {
    try {
      ...
      RescriptReactRouter.replace(
        HSwitchGlobalVars.appendDashboardPath("/3ds"),
      );
      Curry._1(setPageView, function (param) {
        return /* LANDING */ 1;
      });
  ...
  var validate = function (values) {
    ...
    var jsonDict = Core__Option.flatMap(
      dict["algorithm"],
      Core__JSON.Decode.object,
    );
    if (jsonDict !== undefined) {
      var rules = LogicUtils.getArrayFromDict(
        Caml_option.valFromOption(jsonDict),
        "rules",
        [],
      );
  ...
  var redirectToNewRule = function (param) {
    Curry._1(setPageView, function (param) {
      return /* NEW */ 0;
    });
    RescriptReactRouter.replace(
      HSwitchGlobalVars.appendDashboardPath("/3ds?type=new"),
    );
  };
          ...
          ? React.createElement(
              ...
              React.createElement(UIUtils.RenderIf.make, {
                ...
                children: React.createElement(
                  HSwitchThreeDS$ActiveRulePreview,
                  {
                    ...
                    if (showWarning) {
                      return Curry._1(showPopUp, {
                        ...
                        handleConfirm: {
                          text: "Confirm",
                          onClick: function (param) {
                            redirectToNewRule(undefined);
                          },
                        },
                      });
                    } else {
                      return redirectToNewRule(undefined);
                    }
                  },
