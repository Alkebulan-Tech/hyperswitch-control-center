...
import * as Country from "./Country.bs.js";
...
function HSwitchUtils$TextFieldRow(props) {
  ...
  var isRequired$1 = isRequired !== undefined ? isRequired : true;
  var labelWidth$1 = labelWidth !== undefined ? labelWidth : "w-72";
...
function HSwitchUtils$BackgroundImageWrapper(props) {
  var isBackgroundFullScreen = props.isBackgroundFullScreen;
  var customPageCss = props.customPageCss;
  var backgroundImageUrl = props.backgroundImageUrl;
  var children = props.children;
  var backgroundImageUrl$1 =
    backgroundImageUrl !== undefined
      ? backgroundImageUrl
      : "/images/hyperswitchImages/PostLoginBackground.svg";
  var customPageCss$1 = customPageCss !== undefined ? customPageCss : "";
  var isBackgroundFullScreen$1 =
    isBackgroundFullScreen !== undefined ? isBackgroundFullScreen : true;
  var heightWidthCss = isBackgroundFullScreen$1
    ? "h-screen w-screen"
    : "h-full w-full";
    ...
    children: React.createElement(
      "div",
      {
        className:
          ...
          "",
        style: {
          backgroundImage: "url(" + backgroundImageUrl$1 + ")",
...
function setMerchantDetails(key, value) {
  var localStorageData = HSLocalStorage.getInfoFromLocalStorage("merchant");
...
function getSearchOptionsForProcessors(processorList, getNameFromString) {
  return processorList.map(function (item) {
    return [
      "Connect " +
        LogicUtils.capitalizeString(Curry._1(getNameFromString, item)) +
        "",
      "/new?name=" + Curry._1(getNameFromString, item) + "",
    ];
  });
}
...
function useMerchantDetailsValue(param) {
...
function getBrowswerDetails(param) {
...
function getBodyForFeedBack(values, modalTypeOpt, param) {
  var modalType =
    modalTypeOpt !== undefined ? modalTypeOpt : /* FeedBackModal */ 0;
...
function urlPath(urlPathList) {
  if (HSwitchGlobalVars.dashboardBasePath !== undefined && urlPathList) {
...
function getConnectorIDFromUrl(urlList, defaultValue) {
  if (HSwitchGlobalVars.dashboardBasePath !== undefined) {
