...
function Disputes(props) {
  ...
  var getDisputesList = async function (param) {
    try {
      ...
      if (disputesValue.length > 0) {
        Curry._1(setDisputesData, function (param) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(UIUtils.RenderIf.make, {
        condition: match$6.generateReport,
        children: React.createElement(GenerateReport.make, {
          entityName: /* DISPUTE_REPORT */ 33,
        }),
      }),
    ),
