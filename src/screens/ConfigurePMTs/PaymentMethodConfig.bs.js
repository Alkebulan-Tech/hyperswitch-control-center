...
function PaymentMethodConfig$PmtConfigInp(props) {
  ...
  var input_onChange = function (ev) {
    if (ev.length <= 0) {
      ...
      Curry._1(enabledList.onChange, ev);
      return Curry._1(enableType.onChange, "enable_only");
    }
  };
  ...
  return React.createElement(SelectBox.BaseDropdown.make, {
    ...
    dropdownClassName:
      "" + PaymentMethodConfigUtils.dropdownClassName(options) + "",
  });
}
...
function renderValueInp(options, fieldsArray) {
...
function valueInput(inputArg) {
  var partial_arg = inputArg.options;
  return FormRenderer.makeMultiInputFieldInfoOld(
    ...
    undefined,
    function (param) {
      return renderValueInp(partial_arg, param);
    },
    [
...
function PaymentMethodConfig(props) {
  ...
  var config$1 = config !== undefined ? config : "";
  ...
  var getProcessorDetails = async function (param) {
    try {
      Curry._1(setShowPaymentMthdConfigModal, function (param) {
        return true;
      });
      ...
      Curry._1(setCurrencies, function (param) {
        return currencies;
      });
  ...
  var onSubmit = async function (values, param) {
    try {
      ...
      await Curry._1(setReferesh, undefined);
      Curry._1(setShowPaymentMthdConfigModal, function (param) {
        return false;
      });
    } catch (exn) {
    ...
    React.createElement(ACLDiv.make, {
      ...
      children:
        element !== undefined
          ...
          : LogicUtils.isNonEmptyString(config$1)
            ? config$1
            : "NA",
