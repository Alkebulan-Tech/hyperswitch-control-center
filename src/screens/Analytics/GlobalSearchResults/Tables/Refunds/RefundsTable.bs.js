...
import * as RefundsTableEntity from "./RefundsTableEntity.bs.js";

function RefundsTable$PreviewTable(props) {
  ...
  var tableData = props.data
    ...
    .map(RefundsTableEntity.tableItemToObjMapper);
  return React.createElement(LoadedTable.make, {
    visibleColumns: RefundsTableEntity.visibleColumns,
    defaultSort: {
      key: "",
      order: /* INC */ 0,
    },
    ...
    offset: match[0],
    setOffset: match[1],
    entity: RefundsTableEntity.tableEntity,
...
var PreviewTable = {
  make: RefundsTable$PreviewTable,
};
