...
import * as DisputeTable from "./Tables/Disputes/DisputeTable.bs.js";
import * as HSwitchUtils from "../../Utils/HSwitchUtils.bs.js";
import * as RefundsTable from "./Tables/Refunds/RefundsTable.bs.js";
...
import * as PaymentIntentTable from "./Tables/PaymentIntent/PaymentIntentTable.bs.js";
import * as PaymentAttemptTable from "./Tables/PaymentAttempt/PaymentAttemptTable.bs.js";
...
function SearchResultsPage(props) {
  ...
  var isShowRemoteResults =
    match$3.globalSearch && permissionJson.operationsView === /* Access */ 1;
  var getSearchResults = async function (results) {
    try {
      ...
      var body = LogicUtils.getJsonFromArrayOfJson([["query", query]]);
