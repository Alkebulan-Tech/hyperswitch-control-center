...
function SystemMetricsAnalytics$HSiwtchPaymentConfirmLatency(props) {
  ...
  var getOverallLatency = async function (param) {
    Core__Promise.$$catch(
      Curry._7(
        updateDetails,
        url,
        ...
        Curry._1(setOverallrLatency, function (param) {
  ...
  var getConnectorLatency = function (param) {
    Core__Promise.$$catch(
      Curry._7(
        updateDetails,
        url,
        ...
        Curry._1(setConnectorLatency, function (param) {
          return parseJson(json);
        });
        Curry._1(setIsLoading, function (param) {
          return false;
  ...
  React.useEffect(
    function () {
      ...
      Curry._1(setLatency, function (param) {
        return value;
      });
    },
  ...
  React.useEffect(function () {
    getOverallLatency(undefined);
    getConnectorLatency(undefined);
  }, []);
  if (match[0]) {
    return React.createElement(
      "div",
...
function SystemMetricsAnalytics$SystemMetricsAnalytics(props) {
  ...
  var filterData = Core__Option.getOr(match$3[0], {});
        ...
        ? React.createElement(
            ...
            React.createElement(
              ...
              JsxPPXReactSupport.createElementWithKey("1", DynamicFilter.make, {
                ...
                options: [],
                popupFilterFields: [],
                initialFixedFilters: Curry._1(
                  props.initialFixedFilters,
                  filterData,
                ),
