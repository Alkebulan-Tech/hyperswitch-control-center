...
function itemToObjMapper(json) {
  ...
  return Core__Option.getOr(data[0], singleStateInitialValue);
}
...
function getStatData(
  ...
  if (colType) {
    ...
    var partial_arg$1 = singleStatData.api_count;
    return {
      title: "API Count",
      tooltipText:
  ...
  var partial_arg$3 = singleStatData.latency;
  return {
    title: "APIs latency",
    tooltipText:
