...
function RefundsAnalytics(props) {
  ...
  var getRefundDetails = async function (param) {
    try {
      Curry._1(setScreenState, function (param) {
        return /* Loading */ 0;
      });
      var refundUrl = APIUtils.getURL(
        /* REFUNDS */ 4,
        /* Post */ 2,
        "refund-post",
        undefined,
      ...
      var body = {};
      body["limit"] = 100;
      var refundDetails = await Curry._7(
        updateDetails,
        refundUrl,
        body,
        /* Post */ 2,
    ...
    children: Caml_option.some(
      JsxPPXReactSupport.createElementWithKey(
        ...
        Analytics.make,
        {
          ...
          tableEntity: RefundsAnalyticsEntity.refundTableEntity(undefined),
          ...
          moduleName: "Refunds",
          generateReportType: /* REFUND_REPORT */ 32,
        },
      ),
    ),
    screenState: match[0],
