...
function UserRoleEntry(props) {
  ...
  var getUserData = async function (param) {
    Curry._1(setScreenStateUsers, function (param) {
      return /* Loading */ 0;
    });
    try {
      ...
      Curry._1(setUsersData, function (param) {
        return userData.map(function (prim) {
          return prim;
        });
      });
      Curry._1(setUsersFilterData, function (param) {
        return userData.map(function (prim) {
          return prim;
        });
      });
      return Curry._1(setScreenStateUsers, function (param) {
        return /* Success */ 1;
      });
    } catch (exn) {
      return Curry._1(setScreenStateUsers, function (param) {
  ...
  var buttonValueBasedonTab = match$7
    ? React.createElement(ACLButton.make, {
        ...
        onClick: function (param) {
          ...
          RescriptReactRouter.push(
            HSwitchGlobalVars.appendDashboardPath("/users/create-custom-role"),
          );
        },
    ...
    : React.createElement(ACLButton.make, {
        ...
        onClick: function (param) {
          ...
          RescriptReactRouter.push(
            HSwitchGlobalVars.appendDashboardPath("/users/invite-users"),
          );
        },
        customButtonStyle: "w-48",
        access: userPermissionJson.usersManage,
