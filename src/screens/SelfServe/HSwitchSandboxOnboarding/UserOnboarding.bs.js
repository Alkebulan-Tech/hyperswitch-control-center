...
function UserOnboarding(props) {
    ...
    function () {
      if (dashboardPageState !== "HOME") {
        RescriptReactRouter.push(
          HSwitchGlobalVars.appendDashboardPath("/onboarding"),
        );
      }
    },
    [dashboardPageState],
    ...
    function () {
      ...
      switch (filtersFromUrl) {
        case "integrate-from-scratch":
          routeType = /* IntegrateFromScratch */ 1;
          break;
        case "migrate-from-stripe":
          routeType = /* MigrateFromStripe */ 0;
          break;
        case "sample-projects":
          routeType = /* SampleProjects */ 4;
          break;
        case "woocommerce-plugin":
          routeType = /* WooCommercePlugin */ 3;
          break;
        default:
          routeType = /* OnboardingDefault */ 2;
      }
      Curry._1(setCurrentRoute, function (param) {
        return routeType;
      });
  ...
  var markAsDone = async function (param) {
    try {
      var url = APIUtils.getURL(
        /* INTEGRATION_DETAILS */ 24,
        /* Post */ 2,
