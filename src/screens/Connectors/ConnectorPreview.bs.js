...
function ConnectorPreview$DeleteConnectorMenu(props) {
  ...
  var deleteConnector = async function (param) {
    try {
              ...
              "a",
              {
                ...
                onClick: function (param) {
                  RescriptReactRouter.push(
                    HSwitchGlobalVars.appendDashboardPath("/configure-pmt"),
                  );
                },
              },
...
function ConnectorPreview(props) {
  ...
  var showMenuOption = props.showMenuOption;
  var isUpdateFlow = props.isUpdateFlow;
  var setCurrentStep = props.setCurrentStep;
  var connectorInfo = props.connectorInfo;
  var showMenuOption$1 = showMenuOption !== undefined ? showMenuOption : true;
  ...
  if (props.currentStep !== 3) {
    tmp = React.createElement(Button.make, {
      ...
      onClick: function (param) {
        ...
        if (isFeedbackModalToBeOpen) {
          Curry._1(setShowFeedbackModal, function (param) {
            return true;
          });
        }
        RescriptReactRouter.push(
          HSwitchGlobalVars.appendDashboardPath(redirectPath),
        );
      },
    });
  } else {
    ...
    switch (match$5.TAG | 0) {
      case /* Processors */ 0:
        if (
          match$5._0 !== 26 ||
          !(match$6 === "inactive" && paypalAutomaticFlow)
        ) {
          exit = 1;
        } else {
          tmp = React.createElement(Button.make, {
    ...
    if (exit === 1) {
      ...
      switch (match$7.TAG | 0) {
        case /* Processors */ 0:
          if (match$7._0 !== 26 || !paypalAutomaticFlow) {
            exit$1 = 2;
          } else {
            tmp$1 = React.createElement(MenuOptionForPayPal.make, {
              updateStepValue: /* PaymentMethods */ 1,
