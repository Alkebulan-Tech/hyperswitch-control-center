...
function ConnectorPaymentMethod(props) {
  ...
  var setPaymentMethodDetails = async function (param) {
    try {
  ...
  React.useEffect(
    function () {
      setPaymentMethodDetails(undefined);
    },
    [connector],
  );
  var mixpanelEventName = isUpdateFlow
    ...
    : "processor_step2";
  var onSubmit = async function (param) {
    Curry._4(mixpanelEvent, mixpanelEventName, undefined, undefined, undefined);
    try {
      Curry._1(setScreenState, function (param) {
        return /* Loading */ 0;
      });
