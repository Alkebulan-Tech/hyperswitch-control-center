...
var buildInitialSurchargeValue_name =
  "Surcharge -" + RoutingUtils.getCurrentUTCTime(undefined) + "";
...
function getTypedSurchargeConnectorSelection(ruleDict) {
  return AdvancedRoutingUtils.getDefaultSelection(
    LogicUtils.getDictfromDict(ruleDict, "connectorSelection"),
  );
}
...
function ruleInfoTypeMapper(json) {
  ...
  var rulesModifiedArray = rulesArray.map(function (rule) {
    ...
    var connectorSelection = AdvancedRoutingUtils.getDefaultSelection(
      LogicUtils.getDictfromDict(ruleDict, "connectorSelection"),
    );
