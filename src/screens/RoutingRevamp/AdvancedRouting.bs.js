...
function AdvancedRouting$Add3DSCondition(props) {
  ...
  var arg = "!-mt-5 " + classStyle + " !rounded-md";
...
function AdvancedRouting$AddSurchargeCondition(props) {
  ...
  React.useEffect(
    function () {
      ...
      Curry._1(setSurchargeValueType, function (param) {
        return valueType;
      });
    },
      ...
      React.createElement(
        ...
        React.createElement(FormRenderer.FieldRenderer.make, {
          field: FormRenderer.makeFieldInfo(
            ...
            function (param) {
              return function (param$1) {
                var param$2 = "Select Surcharge Type";
                var param$3 = true;
                var param$4;
                var param$5;
                var param$6;
...
function AdvancedRouting$Wrapper(props) {
  ...
  var notFirstRule = props.notFirstRule;
  var isFirst = props.isFirst;
  var onClickCopy = props.onClickCopy;
  var heading = props.heading;
  var id = props.id;
  var isFirst$1 = isFirst !== undefined ? isFirst : false;
  var notFirstRule$1 = notFirstRule !== undefined ? notFirstRule : true;
  var isDragging$1 = isDragging !== undefined ? isDragging : false;
  var isFrom3ds$1 = isFrom3ds !== undefined ? isFrom3ds : false;
  var isFromSurcharge$1 =
    isFromSurcharge !== undefined ? isFromSurcharge : false;
  ...
  React.useEffect(function () {
    Curry._1(name.onChange, LogicUtils.titleToSnake(heading.toLowerCase()));
    var gatewayArrPresent =
      LogicUtils.getArrayFromJson(gateWaysInput.value, []).length > 0;
    if (gatewayArrPresent && areValidConditions) {
  ...
  var border = isDragging$1 ? "border-dashed" : "border-solid";
  ...
  var actions = React.createElement(
      ...
      children: React.createElement(
        "div",
        {
          ...
          onMouseEnter: function (param) {
            Curry._1(setDragBtnHover, function (param) {
              return !isMobileView;
            });
          },
    ...
    React.createElement(
      "div",
      {
        ...
        onMouseEnter: function (param) {
          Curry._1(setAddBtnHover, function (param) {
            return !isMobileView;
          });
        },
        onMouseLeave: function (param) {
    ...
    onClickCopy !== undefined
      ? React.createElement(
          "div",
          {
            ...
            onClick: onClickCopy,
            onMouseEnter: function (param) {
              Curry._1(setCopyBtnHover, function (param) {
                return !isMobileView;
              });
            },
            onMouseLeave: function (param) {
    ...
    React.createElement(UIUtils.RenderIf.make, {
      ...
      children: React.createElement(
        "div",
        {
          ...
          onMouseEnter: function (param) {
            Curry._1(setDeleteBtnHover, function (param) {
              return !isMobileView;
            });
          },
          onMouseLeave: function (param) {
      ...
      React.createElement(UIUtils.RenderIf.make, {
        ...
        children: React.createElement(
          AdvancedRoutingUIUtils.MakeRuleField.make,
          {
            ...
            wasm: props.wasm,
            isFrom3ds: isFrom3ds$1,
            isFromSurcharge: isFromSurcharge$1,
          },
        ),
      }),
      React.createElement(UIUtils.RenderIf.make, {
        condition: !isFrom3ds$1 && !isFromSurcharge$1,
...
function AdvancedRouting$RuleBasedUI(props) {
  ...
  React.useEffect(
    function () {
      Curry._1(ruleInput.onChange, rules);
    },
    [rules],
  );
  var addRule = function (index, copy) {
    ...
    var newRule = copy
      ...
      : AdvancedRoutingUtils.defaultRule;
    Curry._1(ruleInput.onChange, existingRules.concat([newRule]));
  };
  var tmp;
        ...
        return JsxPPXReactSupport.createElementWithKey(
          ...
          AdvancedRouting$Wrapper,
          {
            ...
            onClickRemove: function (param) {
              ...
              Curry._1(
                ruleInput.onChange,
                existingRules.filter(function (param, i) {
                  return i !== index;
                }),
              );
            },
        ...
        notFirstRule
          ? React.createElement(DragDropComponent.make, {
              ...
              setListItems: function (v) {
                Curry._1(setRules, function (param) {
                  return v;
                });
              },
...
function AdvancedRouting(props) {
  ...
  var activeRoutingDetails = async function (param) {
    try {
      ...
      Curry._1(setInitialRule, function (param) {
      ...
      return Curry._1(setFormState, function (param) {
        return /* ViewConfig */ 3;
      });
    } catch (raw_e) {
  ...
  var getWasm = async function (param) {
    try {
      var wasmResult = await window.init(undefined);
      var wasm = LogicUtils.getObj(
        LogicUtils.getDictFromJsonObject(wasmResult),
        "wasm",
        {},
      );
      return Curry._1(setWasm, function (param) {
        return wasm;
      });
    } catch (exn) {
      return;
  ...
  React.useEffect(
    function () {
      var fetchDetails = async function (param) {
        try {
          Curry._1(setScreenState, function (param) {
            return /* Loading */ 0;
          });
          await getWasm(undefined);
  ...
  var onSubmit = async function (values, isSaveRule) {
    try {
      ...
      var getActivateUrl = APIUtils.getURL(
        urlEntityName,
        /* Post */ 2,
  ...
  var connectorType =
    match$9 !== 1 ? /* PaymentConnector */ 0 : /* PayoutConnector */ 2;
    ...
    tmp = React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(UIUtils.RenderIf.make, {
            condition: match$5[0] !== /* CreateConfig */ 0,
            children: React.createElement(
              "div",
              {
                className: "mb-5",
