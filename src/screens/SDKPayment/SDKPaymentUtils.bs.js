...
function getCurrencyValue(countryCurrency) {
  return Core__Option.getOr(countryCurrency.split("-")[1], "USD").trim();
}
  ...
  var mandateData_mandate_type = {
    multi_use: {
      ...
      currency: getCurrencyValue(
        LogicUtils.getString(dictOfValues, "currency", "United States-USD"),
      ),
    },
  };
  var mandateData = {
  ...
  return {
    ...
    billing: {
      address: {
        ...
        country: LogicUtils.getString(billingAddress, "country", ""),
...
export { initialValueForForm, getCurrencyValue, getTypedValueForPayment };
