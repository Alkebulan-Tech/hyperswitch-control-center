...
function getBrowswerDetailsPayload(param) {
  var browserDetails = HSwitchUtils.getBrowswerDetails(undefined);
...
function generateSurveyJson(values) {
  ...
  var browserDetailsPayload = getBrowswerDetailsPayload(undefined);
  return Object.fromEntries([
