...
function useConstructQueryOnBasisOfOpt(param) {
  ...
  return function (
    ...
    try {
      ...
      switch (optVal) {
        case "last_month":
          customrange = /* LastMonth */ 4;
          break;
        case "next_month":
          customrange = /* NextMonth */ 6;
          break;
        case "this_month":
          customrange = /* ThisMonth */ 3;
          break;
        case "today":
          customrange = /* Today */ 0;
          break;
        case "tomorrow":
          customrange = /* Tomorrow */ 1;
          break;
        case "yesterday":
          customrange = /* Yesterday */ 2;
          break;
        default:
