...
function useCustomTimeZoneToIsoString(param) {
  var match = React.useContext(UserTimeZoneProvider.userTimeContext);
  var zone = match[0];
  return React.useCallback(
    function (year) {
      return function (month, day, hours, minutes, seconds) {
...
function useIsoStringToCustomTimeZone(param) {
  var match = React.useContext(UserTimeZoneProvider.userTimeContext);
  var zone = match[0];
  return React.useCallback(
    function (isoString) {
      ...
      return en_USStringToDateTimeObject(
        convertTimeZone(isoString, selectedTimeZoneAlias),
      );
    },
    [zone],
  );
...
function useIsoStringToCustomTimeZoneInFloat(param) {
  var match = React.useContext(UserTimeZoneProvider.userTimeContext);
  var zone = match[0];
  return React.useCallback(
    function (isoString) {
      ...
      return dateTimeStringToDateTimeFloat(
        en_USStringToDateTimeObject(timezoneConvertedString),
      );
    },
    [zone],
  );
