...
function AcceptInviteHome(props) {
  ...
  React.useEffect(
    function () {
      ...
      Curry._1(setMerchantListValue, function (param) {
        return filteredSwitchMerchantList;
      });
      Curry._1(setAcceptedMerchantId, function (param) {
  ...
  var acceptInvite = async function (param) {
    try {
      ...
      var body = LogicUtils.getJsonFromArrayOfJson([
        ...
        ["need_dashboard_entry_response", false],
      ]);
      await Curry._7(
        updateDetails,
        url,
                ...
                return React.createElement(
                  ...
                  React.createElement(UIUtils.RenderIf.make, {
                    ...
                    children: React.createElement(Button.make, {
                      ...
                      buttonType: /* PrimaryOutline */ 2,
                      onClick: function (param) {
                        Curry._1(setAcceptedMerchantId, function (prev) {
