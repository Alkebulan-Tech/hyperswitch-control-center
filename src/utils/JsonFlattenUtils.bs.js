...
function flattenObject(obj, addIndicatorForObject) {
  ...
  if (obj$1 !== undefined) {
    Object.entries(Caml_option.valFromOption(obj$1)).forEach(function (entry) {
      var value = entry[1];
      var key = entry[0];
      if (value == null) {
        newDict[key] = value;
...
function setNested(_dict, _keys, value) {
  while (true) {
    ...
    var subDict;
    if (json !== undefined) {
      var obj = Core__JSON.Decode.object(Caml_option.valFromOption(json));
...
function unflattenObject(obj) {
  ...
  if (dict !== undefined) {
    Object.entries(Caml_option.valFromOption(dict)).forEach(function (entry) {
