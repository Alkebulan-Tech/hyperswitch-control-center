          ...
          React.createElement(
            ...
            React.createElement(Icon.make, {
              ...
              onClick: function (param) {
                Curry._2(setLclFltrState, filterKey, []);
              },
            }),
          ),
        )
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        {
          ...
          type: "button",
          onClick: function (param) {
            Curry._1(setShowDropDown, function (prev) {
              return !prev;
            });
          },
        },
    ...
    function () {
      return {
        ...
        onChange: function (ev) {
          ...
          Curry._2(setLclFltrState, val, [value$1]);
        },
    ...
    function () {
      return {
        ...
        onChange: function (ev) {
          ...
          if (ele !== undefined) {
            return Curry._2(setLclFltrState, val, [
              Caml_obj.greaterthan(leftVal, rightvalue) ? rightvalue : leftVal,
              Caml_option.valFromOption(ele),
            ]);
          }
        },
        onFocus: function (_ev) {},
    ...
    function () {
      return {
        ...
        onChange: function (ev) {
          ...
          var ele$1 = Caml_option.valFromOption(ele);
          Curry._2(setLclFltrState, val, [
            ele$1,
            Caml_obj.greaterthan(ele$1, rightvalue) ? ele$1 : rightvalue,
          ]);
        },
        onFocus: function (_ev) {},
