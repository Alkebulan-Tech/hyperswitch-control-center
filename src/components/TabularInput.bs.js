...
function TabularInput$FieldInputRenderer(props) {
  return React.createElement(
    "td",
    undefined,
    Curry._1(props.item, props.input),
  );
}
  ...
  return React.createElement(
    ...
    props.fields.map(function (itm, i) {
      ...
      var input_onChange = function (ev) {
        var $$event = ev.target;
        Curry._3(onChange, elemIndex, i, $$event.value);
      };
    ...
    React.createElement(
      ...
      React.createElement(Button.make, {
        ...
        onClick: Curry._2(props.onClick, elemIndex, isLast),
      }),
    ),
  );
}
...
function TabularInput(props) {
  ...
  var onChange = function (elemIndex, coloumnIndex, value) {
    ...
    Curry._1(onKeyUp, a);
    Curry._1(setKeyValue, function (param) {
      return a;
    });
  };
  var onClick = function (elemIndex, isLast, param) {
    var value = isLast
