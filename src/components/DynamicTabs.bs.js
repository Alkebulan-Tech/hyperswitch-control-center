...
function setTabScroll(
  ...
  var leftVal = Curry._2(getBoundingRectInfo, firstTabRef, function (val) {
    return val.x;
  });
  var rightVal = Curry._2(getBoundingRectInfo, lastTabRef, function (val) {
    return val.right;
  });
  var scrollValLeft = Curry._2(getBoundingRectInfo, scrollRef, function (val) {
    return val.x;
  });
  var scrollValRight = Curry._2(getBoundingRectInfo, scrollRef, function (val) {
    return val.right;
  });
...
function DynamicTabs$TabInfo(props) {
  ...
  var defaultClasses =
    ...
    " w-max flex flex-auto flex-row items-center justify-center text-body";
    ...
    ? React.createElement(
        "svg",
        {
          ...
          onClick: function (ev) {
            ev.stopPropagation();
            ev.preventDefault();
            Curry._1(setTabStacksnames, function (prev) {
            ...
            Curry._1(setCollapsibleTabs, function (param) {
  ...
  return React.createElement(
    "div",
    {
      className: "flex flex-row cursor-pointer pt-0.5 pb-0   items-center",
      style: {
        height: "47px",
      },
    },
  ...
  return React.createElement(UIUtils.RenderIf.make, {
    ...
    children: React.createElement(
      ...
      React.createElement(Button.make, {
        buttonState: isVisible ? /* Normal */ 0 : /* Disabled */ 2,
...
function DynamicTabs(props) {
  var toolTipDescription = props.toolTipDescription;
  var enableDescriptionHeader = props.enableDescriptionHeader;
  ...
  var disableIndicationArrow = props.disableIndicationArrow;
  var tabs = props.tabs;
  var disableIndicationArrow$1 =
    disableIndicationArrow !== undefined ? disableIndicationArrow : false;
  var tabContainerClass$1 =
    tabContainerClass !== undefined ? tabContainerClass : "";
  var maxSelection$1 = maxSelection !== undefined ? maxSelection : 3;
  var tabId$1 = tabId !== undefined ? tabId : "";
  var enableDescriptionHeader$1 =
    enableDescriptionHeader !== undefined ? enableDescriptionHeader : false;
  var toolTipDescription$1 =
    toolTipDescription !== undefined ? toolTipDescription : "Add more tabs";
  var isMobileView = MatchMedia.useMobileChecker(undefined);
  ...
  var availableTabUserPrefKey = "dynamicTab_available_tab_" + tabId$1 + "";
  ...
  var match$3 = React.useMemo(function () {
    ...
    var jsonVal = Curry._1(getConfig, availableTabUserPrefKey);
    var collapsibleTabs;
    if (jsonVal !== undefined) {
      var tabsFromPreference = LogicUtils.getStrArryFromJson(
        Caml_option.valFromOption(jsonVal),
      ).filter(function (item) {
      ...
      collapsibleTabs = Belt_Array.keepMap(
        ...
        function (tabName) {
          ...
          if (
            !(
              validated &&
              tabName$1.length <= maxSelection$1 &&
              tabName$1.length > 0
            )
          ) {
            return;
          ...
          return {
            ...
            description:
              tabValue$1 !== undefined && enableDescriptionHeader$1
    ...
    if (
      ...
      if (concatinatedTabIndex === -1) {
        ...
        Curry._1(setTabDetails, function (param) {
          return tabsDetails.concat(newTab);
        });
        Curry._1(
          setActiveTab,
          getValueFromArrayTab(updatedColllapsableTab, collapsibleTabs.length),
        );
        Curry._1(
          updateTabNameWith,
          Object.fromEntries([
            [
              ...
              "[" +
                getValueFromArrayTab(
                  updatedColllapsableTab,
                  collapsibleTabs.length,
                ) +
                "]",
            ],
          ]),
      ...
      Curry._1(
        setActiveTab,
        getValueFromArrayTab(collapsibleTabs, concatinatedTabIndex),
      );
      Curry._1(
        updateTabNameWith,
        Object.fromEntries([
    ...
    Curry._1(setActiveTab, getValueFromArrayTab(collapsibleTabs, 0));
    Curry._1(
      updateTabNameWith,
      Object.fromEntries([
        ["tabName", "[" + getValueFromArrayTab(collapsibleTabs, 0) + "]"],
      ]),
    );
    return [0, collapsibleTabs];
  }, []);
  var updatedCollapsableTabs = match$3[1];
  var initialIndex = match$3[0];
  var match$4 = React.useState(function () {
    return updatedCollapsableTabs;
  });
  var setCollapsibleTabs = match$4[1];
  var collapsibleTabs = match$4[0];
  React.useEffect(
    function () {
      var collapsibleTabsValues = collapsibleTabs.map(function (item) {
        return item.value;
      });
      Curry._2(addConfig, availableTabUserPrefKey, collapsibleTabsValues);
    },
    [collapsibleTabs],
  );
  ...
  var setTabStacksnames = match$5[1];
  var tabStacksnames = match$5[0];
  var match$6 = React.useState(function () {
    return initialIndex;
  });
  var setSelectedIndex = match$6[1];
  var selectedIndex = match$6[0];
  var match$7 = React.useState(function () {
    return false;
  });
  var setIsLeftArrowVisible = match$7[1];
  var match$8 = React.useState(function () {
    return true;
  });
  var setIsRightArrowVisible = match$8[1];
  ...
  var handleSelectedTab = function (tabValue, collapsibleTabs, removed) {
    if (removed === false) {
      ...
      Curry._1(setActiveTab, tabValue);
  ...
  var onSubmit = function (values) {
    ...
    if (
      ...
      Curry._1(setActiveTab, values.join(","));
    } else {
      var newTab = [
        {
          title: tabName,
      ...
      Curry._1(setActiveTab, getValueFromArrayTab(newTab, 0));
  ...
  var formattedOptions = tabs.map(function (x) {
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("div", {
              className: disableIndicationArrow$1 ? "hidden" : "block",
            }),
          ),
        ),
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(ToolTip.make, {
              description: toolTipDescription$1,
      ...
      React.createElement(SelectModal.make, {
        ...
        modalHeadingDescription:
          "You can choose upto maximum of " +
          maxSelection$1.toString() +
          " segments",
        showModal: match$9[0],
